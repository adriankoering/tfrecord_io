...
def add_detection_features(boxes: np.ndarray, labelids: List[int],
...
def create_image_example(image: np.ndarray,
                         encoding_format: str = "jpeg") -> tf.train.Example:
...
def create_classification_example(image: np.ndarray,
                                  labelids: int,
...
def create_probability_example(image: np.ndarray,
                               labelids: int,
...
def create_detection_example(image: np.ndarray,
                             boxes: np.ndarray,
                             labelids: List[int],
                             class_names: List[bytes],
                             encoding_format: str = "jpeg") -> tf.train.Example:
...
def create_instance_segmentation_example(image: np.ndarray,
                                         boxes: np.ndarray,
                                         labelids: List[int],
                                         class_names: List[bytes],
...
def create_segmentation_example(image: np.ndarray,
...
def create_classification_and_segmentation_example(image: np.ndarray,
                                                   labelid: int,
                                                   segmentation: np.ndarray,
                                                   encoding_format: str = "jpeg"
                                                  ) -> tf.train.Example:
